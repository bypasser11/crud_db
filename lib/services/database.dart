...
import 'package:crud_db/services/api_path.dart';
import 'package:crud_db/services/firestore_service.dart';
...
class FirestoreDatabase implements Database {
  ...
  Future<void> deleteJob(Job job) async {
    // delete where entry.jobId == job.jobId. Get the job
    final allEntries = await entriesStream(job: job).first;
    //delete the entry of the job one by one
